...
import org.jboss.as.plugin.deployment.DeploymentArchive;
...
public class Run extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        final File modulesPath = (this.modulesPath == null ? Files.createFile(jbossHome, "modules") : new File(this.modulesPath));
        final File bundlesPath = (this.bundlesPath == null ? Files.createFile(jbossHome, "bundles") : new File(this.bundlesPath));
        ...
        try {
            ...
            // Create the server
            final StandaloneServer server = new StandaloneServer(ConnectionInfo.DEFAULT, jbossHome, modulesPath, bundlesPath, jvmArgs, javaHome, serverConfig, startupTimeout);
            ...
            while (server.isServerInRunningState()) {
            }
        } catch (Exception e) {
